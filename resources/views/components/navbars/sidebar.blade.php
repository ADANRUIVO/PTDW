...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">GCPE</span>
        </a>
    </div>
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'notifications' ? ' active bg-gradient-primary' : '' }}  "
                    ...
                    <span class="nav-link-text ms-1">Notificacoes</span>
                </a>
            </li>
            <li class="nav-item mt-3">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-gradient-primary w-100" href="#" target="_blank">Orçamentos</a>
        </div>
        <div class="mx-3">
            <a class="btn bg-gradient-primary w-100" href="#" target="_blank">Relatorios</a>
        </div>
        <div class="mx-3">
            <a class="btn bg-gradient-primary w-100"
                href="#" target="_blank" type="button">Listar Clientes</a>
        </div>
    </div>
