        ...
        <div class="row align-items-center justify-content-lg-between">
            ...
            <div class="col-12 col-md-6">
                <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                    <li class="nav-item">
                        <a href="https://www.creative-tim.com" class="nav-link text-white" target="_blank">Criatividade
                            Tim</a>
                    </li>
                    <li class="nav-item">
                        <a href="https://www.updivision.com" class="nav-link text-white" target="_blank">DAdos</a>
                    </li>
                    <li class="nav-item">
